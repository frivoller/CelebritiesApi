...
namespace CelebritiesApi.Controllers
{
    ...
    public class CelebritiesController : ControllerBase
    {
        ...
        {
            new Celebrity { Id = 1, Name = "Chappell Roan", Profession = "Musician" },
            new Celebrity { Id = 2, Name = "Keanu Reeves", Profession = "Actor" },
            new Celebrity { Id = 3, Name = "Emre Aydın", Profession = "Musician" },
            new Celebrity { Id = 4, Name = "Ella Purnell", Profession = "Actress" }
        };
        ...
        {
            celebrity.Id = celebrities.Max(c => c.Id) + 1; // new id
